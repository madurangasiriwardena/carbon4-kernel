...
//    }
    ...
    public static UserRealm getRealmByUserName(RealmService realmService, String userName) throws CarbonException {
        try {
            String tenantDomain = MultitenantUtils.getTenantDomain(userName);
            return AnonymousSessionUtil.getRealmByTenantDomain(realmService,
                    tenantDomain);
        } catch (Exception e) {
            throw new CarbonException(e.getMessage(), e);
        }
    ...
    public static UserRealm getRealmByTenantDomain(RealmService realmService, String tenantDomain)
            throws CarbonException {
        try {
